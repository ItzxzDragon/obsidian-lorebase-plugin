...
export interface MangaItem extends BaseMediaItem { type: 'manga'; status: ReadingStatus; authors: string[]; artists: string[]; chapterCurrent: number | null; chapterTotal: number | null; volumeCurrent: number | null; volumeTotal: number | null; dateAdded: number; lastModified: number; genres: string[]; tags: string[]; sourceUrl?: string | null; integrationProvider?: 'anilist' | 'jikan' | 'shikimori' | 'mangaupdates' | 'mangadex' | null; integrationId?: string | null; parts?: MangaPart[]; activePartId?: string | null; relatedMedia?: RelatedMediaLink[]; }
